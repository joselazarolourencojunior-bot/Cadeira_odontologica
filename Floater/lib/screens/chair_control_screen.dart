...
class _ChairControlScreenState extends State<ChairControlScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (bluetooth.isConnected &&
        !_chairIdUpdated &&
        SupabaseService.instance.chairSerialNumber == 'CADEIRA-DESCONHECIDA') {
  ...
  Future<void> _checkChairStatus() async {
    ...
    if (chairId != null) {
      supabase.setChairSerialNumber(chairId);
      debugPrint('📋 Cadeira registrada: $chairId');
    } else {
      debugPrint('⚠️ Dispositivo não conectado, usando ID padrão');
      supabase.setChairSerialNumber('CADEIRA-DESCONHECIDA');
    }
